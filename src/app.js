...
const update_from_url_params = () => {
	...
	setTimeout(() => {
		...
		if (location.pathname.match(/overlay/i)) {
			view_overlay();
		}
	}, 500);
};
...
$status_text.default = () => {
	$status_text.text(localize("StreamElements ❤️ JS Paint."));
};
$status_text.default();
